  ...
  /* MISC */
    ...
    public void init() throws ServletException {
        ...
        RequestConfig config = RequestConfig.custom()
          .setRedirectsEnabled(readConfigParam(ClientPNames.HANDLE_REDIRECTS, Boolean.class, true))
          .build();

        proxyClient = createHttpClient(config);
    }
    ...
    protected HttpClient createHttpClient(RequestConfig config) {
     ...
     * returns it.
     */
    protected <T> T readConfigParam(String hcParamName, Class<T> type, T defaultValue) {
